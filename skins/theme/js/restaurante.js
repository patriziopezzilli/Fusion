jQuery(document).ready(function(){
		...
		// CONTACT FORM
			jQuery("#contactform").submit(function() {
				var url = "skins/theme/lib/sendmail.php"; // the script where you handle the form input.
				...
				jQuery.ajax({
					   ...
					   success: function(data)
					   {
							...
							//alert(data);
							alert("Grazie, ti risponderemo al più presto"); // show response from the php script.
		...
		// NEWSLETTER FORM
			jQuery("#newsletter").submit(function() {
				var url = "skins/theme/lib/newsletter.php"; // the script where you handle the form input.
				...
				jQuery.ajax({
					   ...
					   success: function(data)
					   {
							...
							//alert(data);
							alert("Grazie per esserti registrato!"); // show response from the php script.
							return false; // avoid to execute the actual submit of the form.
					   }
